 ...
 */
public class SinVoicePlayer implements Encoder.EncoderCallback, PcmPlayer.PcmListener, PcmPlayer.PcmCallback {
     ...
     * @param bufferSize 缓冲区体积
     * @param buffCount  缓冲区数量
     */
    public SinVoicePlayer(String codeBook, int sampleRate, int bufferSize, int buffCount) {
        ...
        pcmPlayer = new PcmPlayer(this, sampleRate, AudioFormat.CHANNEL_OUT_MONO, AudioFormat.ENCODING_PCM_16BIT, bufferSize);
